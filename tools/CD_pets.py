...
def get_oxford_pets_datasets(train_transform, 
                          ...
                          seed=0,
                          data_root=oxford_pet_root):

    np.random.seed(seed)

    # Init entire training set
    whole_training_set = OxfordPetDataset(root=data_root, transform=train_transform)
    ...
    whole_test_dataset = OxfordPetDataset(root=data_root, transform=test_transform, split='test')
