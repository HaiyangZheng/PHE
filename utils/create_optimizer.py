...
def split_weights(model, joint_optimizer_lrs, weight_decay=None, skip_list=[]):
    ...
    if weight_decay is None:
        ...
        # if hasattr(model, 'openset_head'):
        #     res_params.append({'params': model.openset_head.parameters(), 'lr': joint_optimizer_lrs['prototype_vectors']})
        if hasattr(model, 'hash_head'):
            res_params.append({'params': model.hash_head.parameters(), 'lr': joint_optimizer_lrs['prototype_vectors']})
        # if hasattr(model, 'hash_center_head'):
        #     res_params.append({'params': model.hash_center_head.parameters(), 'lr': joint_optimizer_lrs['prototype_vectors']})
